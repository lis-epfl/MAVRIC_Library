...
LIB_SRCS += control/mission_planner.cpp
LIB_SRCS += control/mission_planner_handler.cpp
LIB_SRCS += control/mission_planner_handler_hold_position.cpp
LIB_SRCS += control/mission_planner_handler_landing.cpp
LIB_SRCS += control/mission_planner_handler_manual_control.cpp
LIB_SRCS += control/mission_planner_handler_navigating.cpp
LIB_SRCS += control/mission_planner_handler_on_ground.cpp
LIB_SRCS += control/mission_planner_handler_stop_on_position.cpp
LIB_SRCS += control/mission_planner_handler_stop_there.cpp
LIB_SRCS += control/mission_planner_handler_takeoff.cpp
