...
void mavlink_actions_init(void) {
	...
	scheduler_add_task(get_mavlink_taskset(),  500000, RUN_NEVER, &mavlink_send_raw_imu, MAVLINK_MSG_ID_RAW_IMU);
	...
	scheduler_add_task(get_mavlink_taskset(),  250000, RUN_NEVER, &mavlink_send_servo_output, MAVLINK_MSG_ID_SERVO_OUTPUT_RAW);
...
//	scheduler_add_task(get_mavlink_taskset(),  50000, &mavlink_send_radar);
	...
	scheduler_add_task(get_mavlink_taskset(),  250000, RUN_NEVER, &mavlink_send_gps_raw, MAVLINK_MSG_ID_GPS_RAW_INT);
