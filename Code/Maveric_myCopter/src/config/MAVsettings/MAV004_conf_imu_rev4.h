...
#define RAW_ACC_X_SCALE 4101							///< Accelerometer x axis scale
#define RAW_ACC_Y_SCALE 3900.6							///< Accelerometer y axis scale
#define RAW_ACC_Z_SCALE 4222.8							///< Accelerometer z axis scale

#define ACC_BIAIS_X  64									///< Accelerometer x axis biais
#define ACC_BIAIS_Y  64									///< Accelerometer y axis biais
#define ACC_BIAIS_Z 420									///< Accelerometer z axis biais
...
#define RAW_MAG_X_SCALE 624.21							///< Compass x axis scale
#define RAW_MAG_Y_SCALE 590.0							///< Compass y axis scale
#define RAW_MAG_Z_SCALE 512.0							///< Compass z axis scale

#define MAG_BIAIS_X 180									///< Compass x axis biais
#define MAG_BIAIS_Y  40									///< Compass y axis biais
#define MAG_BIAIS_Z 112									///< Compass z axis biais
