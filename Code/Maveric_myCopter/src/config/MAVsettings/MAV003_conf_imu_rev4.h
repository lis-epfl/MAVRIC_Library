...
#define RAW_ACC_X_SCALE 4017.3					 		///< Accelerometer x axis scale
#define RAW_ACC_Y_SCALE 4036.0					 		///< Accelerometer y axis scale
#define RAW_ACC_Z_SCALE 3960.8					 		///< Accelerometer z axis scale

#define ACC_BIAIS_X 32							 		///< Accelerometer x axis biais
#define ACC_BIAIS_Y 64							 		///< Accelerometer y axis biais
#define ACC_BIAIS_Z 90							 		///< Accelerometer z axis biais
...
#define RAW_MAG_X_SCALE 451.1					 		///< Compass x axis scale
#define RAW_MAG_Y_SCALE 447.6					 		///< Compass y axis scale
#define RAW_MAG_Z_SCALE 386.7					 		///< Compass z axis scale

#define MAG_BIAIS_X -282						 		///< Compass x axis biais
#define MAG_BIAIS_Y -234						 		///< Compass y axis biais
#define MAG_BIAIS_Z   66						 		///< Compass z axis biais
