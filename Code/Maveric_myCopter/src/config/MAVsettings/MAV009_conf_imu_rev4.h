...
#define RAW_ACC_X_SCALE 4116.1							///< Accelerometer x axis scale
#define RAW_ACC_Y_SCALE 4029.3							///< Accelerometer y axis scale
#define RAW_ACC_Z_SCALE 4152.3							///< Accelerometer z axis scale
...
#define RAW_MAG_X_SCALE 576.7							///< Compass x axis scale
#define RAW_MAG_Y_SCALE 556.3							///< Compass y axis scale
#define RAW_MAG_Z_SCALE 521.0							///< Compass z axis scale

#define MAG_BIAIS_X 110									///< Compass x axis biais
#define MAG_BIAIS_Y  10									///< Compass y axis biais
