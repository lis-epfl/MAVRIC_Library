...
#define RAW_ACC_X_SCALE 4147.06							///< Accelerometer x axis scale
#define RAW_ACC_Y_SCALE 4177.84							///< Accelerometer y axis scale
#define RAW_ACC_Z_SCALE 4002.53							///< Accelerometer z axis scale

#define ACC_BIAIS_X -26.18								///< Accelerometer x axis biais
#define ACC_BIAIS_Y 196.89								///< Accelerometer y axis biais
#define ACC_BIAIS_Z  -0.147								///< Accelerometer z axis biais
...
#define RAW_MAG_X_SCALE 624.82							///< Compass x axis scale
#define RAW_MAG_Y_SCALE 681.96							///< Compass y axis scale
#define RAW_MAG_Z_SCALE 567.10							///< Compass z axis scale

#define MAG_BIAIS_X   85.79								///< Compass x axis biais
#define MAG_BIAIS_Y  263.52								///< Compass y axis biais
#define MAG_BIAIS_Z -318.27								///< Compass z axis biais
