...
void init_mavlink_actions(void) {
	...
	add_task(get_mavlink_taskset(), 1000000, RUN_REGULAR, &mavlink_send_raw_imu, MAVLINK_MSG_ID_RAW_IMU);
	...
	add_task(get_mavlink_taskset(), 1000000, RUN_REGULAR, &mavlink_send_servo_output, MAVLINK_MSG_ID_SERVO_OUTPUT_RAW);
