...
mode_flag_armed_t get_armed_flag(remote_mode_t* remote_mode)
{
	const remote_t* remote = remote_mode->remote;
	mode_flag_armed_t armed = remote_mode->current_desired_mode.flags.ARMED;
...
void remote_mode_update(remote_mode_t* remote_mode)
{
	...
	else
	{
		...
		else
		{
			...
			new_desired_mode.flags.ARMED = remote_mode->current_desired_mode.flags.ARMED;
		}
	}
