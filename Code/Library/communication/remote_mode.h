...
#ifndef REMOTE_MODE_H__
#define REMOTE_MODE_H__
...
typedef struct
{
	...
	const remote_t* 	remote;						///< Pointer to remote
} remote_mode_t;


void remote_mode_init(remote_mode_t* mode_from_remote, const remote_mode_conf_t* config, const remote_t* remote);
