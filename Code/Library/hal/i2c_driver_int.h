...
typedef struct {
	...
	unsigned        read_count;
	unsigned read_data_index;
	unsigned write_data_index;
} i2c_packet_conf;
...
typedef struct  {
	...
	char			transfer_in_progress;        // flag indicates if this event is currently being processed. 0: false, 1: true, -1: uninitialised/error
