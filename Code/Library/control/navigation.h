...
typedef struct
{
	...
	orca_t *orcaData;									///< The pointer to the ORCA structure
 ...
 *
 * \param	navigationData		The pointer to the navigation structure
 ...
 *
 * \param	navigationData			The pointer to the navigation data structure
