...
******************************************************************************/
#ifndef DRIVERS_2GCELLULAR_GPRS_H_
#define DRIVERS_2GCELLULAR_GPRS_H_
...
public:
	...
	virtual size_t writeUDP(uint8_t b);
	...
	virtual uint32_t writeUDP(const uint8_t *buf, uint32_t size);
