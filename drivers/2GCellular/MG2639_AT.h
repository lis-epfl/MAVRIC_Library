...
// UDP Link Commands //
///////////////////////
const char UDP_SETUP[] = "+ZIPSETUPU";		// Set up a UDP link
const char UDP_SEND[] = "+ZIPSENDU";		// Send data over a TCP link
const char UDP_STATUS[] = "+ZPPPSTATUSU";	// Check GPRS connection status
