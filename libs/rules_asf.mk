...
LIB_ASF_SRCS += libs/asf/avr32/drivers/intc/exception_noNMI.S
LIB_ASF_SRCS += libs/asf/avr32/utils/startup/startup_uc3.S
LIB_ASF_SRCS += libs/asf/avr32/utils/startup/trampoline_uc3.S
LIB_ASF_SRCS += libs/asf/avr32/drivers/adcifa/adcifa.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/ast/ast.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/dacifb/dacifb.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/eic/eic.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/flashc/flashc.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/gpio/gpio.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/intc/intc.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/pdca/pdca.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/pevc/pevc.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/pm/pm_uc3c.c  
LIB_ASF_SRCS += libs/asf/avr32/drivers/pm/power_clocks_lib.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/pwm/pwm4.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/scif/scif_uc3c.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/spi/spi.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/tc/tc.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/twim/twim.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/usart/usart.c
LIB_ASF_SRCS += libs/asf/avr32/drivers/usbc/usbc_device.c
LIB_ASF_SRCS += libs/asf/avr32/services/delay/delay.c
LIB_ASF_SRCS += libs/asf/avr32/utils/startup/startup_uc3.S
LIB_ASF_SRCS += libs/asf/common/boards/user_board/init.c
LIB_ASF_SRCS += libs/asf/common/services/clock/uc3c/osc.c
LIB_ASF_SRCS += libs/asf/common/services/clock/uc3c/pll.c
LIB_ASF_SRCS += libs/asf/common/services/clock/uc3c/sysclk.c
LIB_ASF_SRCS += libs/asf/common/services/sleepmgr/uc3/sleepmgr.c
LIB_ASF_SRCS += libs/asf/common/services/spi/uc3_spi/spi_master.c
LIB_ASF_SRCS += libs/asf/common/services/usb/class/cdc/device/udi_cdc.c
LIB_ASF_SRCS += libs/asf/common/services/usb/class/cdc/device/udi_cdc_desc.c
LIB_ASF_SRCS += libs/asf/common/services/usb/udc/udc.c
LIB_ASF_SRCS += libs/asf/common/utils/stdio/read.c
LIB_ASF_SRCS += libs/asf/common/utils/stdio/write.c
LIB_ASF_SRCS += libs/asf/common/utils/stdio/stdio_usb/stdio_usb.c